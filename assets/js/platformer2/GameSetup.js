...
const GameSetup = {
    ...
    */
    ...
    assets: {
      ...
      platforms: {
        cobbelstone: { src: "/images/platformer/platforms/cobbelstone.png" },
    ...
    */
    ...
    initLevels: function(path) {  // ensure valid {{site.baseurl}} for path
        ...
        const mineLevel = [
          ...
          { name: 'grass', id: 'platform', class: Platform, data: this.assets.platforms.grass },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 1 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.95 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.9 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.85 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.8 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.7 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.65 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.15, yPercentage: 0.6 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.1, yPercentage: 0.6 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 0.6 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 0.65 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 0.7 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 0.8 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 0.85 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 0.95 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.3, yPercentage: 1 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.35, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.4, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.45, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.5, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.55, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.55, yPercentage: 0.6 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.55, yPercentage: 0.55 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.55, yPercentage: 0.5 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.55, yPercentage: 0.45 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.55, yPercentage: 0.4 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.6, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.65, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.65, yPercentage: 0.7 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.75, yPercentage: 0.75 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.75, yPercentage: 0.8 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.75, yPercentage: 0.85 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.75, yPercentage: 0.9 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.75, yPercentage: 0.95 },
          { name: 'cobbelstone', id: 'jumpPlatform', class: BlockPlatform, data: this.assets.platforms.cobbelstone, xPercentage: 0.75, yPercentage: 1 },
          { name: 'mario', id: 'player', class: Player, data: this.assets.players.mario },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.25, yPercentage: 1 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.2, yPercentage: 1 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.35, yPercentage: 0.7 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.4, yPercentage: 0.7 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.45, yPercentage: 0.7 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.7 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.55, yPercentage: 0.7 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.6, yPercentage: 0.7 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.35, yPercentage: 0.65 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.4, yPercentage: 0.65 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.45, yPercentage: 0.65 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.65 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.55, yPercentage: 0.65 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.6 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.55 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.5 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.45 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.4 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.5, yPercentage: 0.35 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.55, yPercentage: 0.35 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.55, yPercentage: 0.3 },
          { name: 'slime', id: 'slime', class: Slime, data: this.assets.platforms.slime, xPercentage: 0.55, yPercentage: 0.25 },
